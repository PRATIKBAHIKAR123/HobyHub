    ...
    <Table>
      <TableHeader>
        <TableRow>
          ...
          <TableHead className="text-center text-black text-[12px] font-normal trajan-pro">Age Range</TableHead>
          ...
          <TableRow key={index}>
            ...
            <TableCell className="justify-center text-black text-[12px] font-normal trajan-pro">
              <div className="flex flex-col items-center justify-center gap-2">
                <div className="justify-center text-black text-[12px] font-normal trajan-pro">{item.ageFrom}</div>
                <div className="justify-center text-black text-[12px] font-normal trajan-pro">{item.ageTo}</div>
              </div>
            </TableCell>
            ...
            <TableCell className="justify-center text-black text-[12px] font-normal trajan-pro" width={1}>
              <div className="flex items-center justify-center gap-2">
                ...
                <div className="justify-center text-red text-[10px] font-normal trajan-pro" onClick={() => handleDelete(index)}><Trash color="red" /></div>
              </div>
            </TableCell>
          </TableRow>
        ))}
