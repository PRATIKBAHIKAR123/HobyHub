            ...
            {instituteDetails ? (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p>{instituteDetails.firstName} {instituteDetails.lastName}</p>
                </div>
                <div>
                  <p className="font-medium">Contact Phone:</p>
                  <p>{instituteDetails.phoneNumber}</p>
                </div>
                <div>
                  <p className="font-medium">WhatsApp Number:</p>
                  <p>{instituteDetails.whatsappNumber || 'Not specified'}</p>
                </div>
                <div>
                ...
                <div className="md:col-span-2">
                  ...
                  <p>{instituteDetails.address}, {instituteDetails.road ? `${instituteDetails.road}, ` : ''}
                  {instituteDetails.landmark}, {instituteDetails.area ? `${instituteDetails.area}, ` : ''}
                  {instituteDetails.city}, {instituteDetails.state}, {instituteDetails.country} - {instituteDetails.pincode}</p>
                </div>
                <div>
