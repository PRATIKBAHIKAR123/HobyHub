    ...
    <div className="p-4 md:p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mt-6">
        <Card className="p-2 md:p-4 text-center bg-[#d3e1f1]/95 rounded-2xl gap-2 border-4 border-[#d2dae4]">
          ...
          <p className="text-black text-[13px] md:text-[15px] font-normal font-['Trajan_Pro'] flex items-center justify-center gap-2">
        ...
        <Card className="p-2 md:p-4 text-center bg-[#d3e1f1]/95 rounded-2xl border-4 gap-2 border-[#d2dae4]">
          ...
          <p className="text-black text-[13px]  md:text-[15px] font-normal flex items-center justify-center gap-2">
